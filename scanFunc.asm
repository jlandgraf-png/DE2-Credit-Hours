...
Scan1:
	...
	LOAD Mask3
	STORE SONAREN		; Enables sonar 3
ScanLoop:
	LOAD DIST3			; Read sonar 3
...
ScanTurn:
	ADDI -8				; Add 8 degrees to theta
	ADD 33
	JNEG ScanEnd		; If Theta+8 > 45 (since sonar is scanning up until 33 + 12), end scan. Otherwise, continue looping
	SUB 33
	STORE DTheta
ScanTurnLoop:			; Wait until robot finishes turn
	IN DTheta
	SUB Theta
	CALL Abs
	ADDI -3
...
ScanEnd:
	LOAD MinAngle
	SUB 12				; Subtract 12 degrees (for offset of sonar from front)
	STORE DTheta
	...
	LOADI &HFFFF
	STORE MinDist	; Resets min distance
