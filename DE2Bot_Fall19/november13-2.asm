...
TurnPerp:
	...
	;STORE StartingAngle
	LOADI &HFFFF
	STORE MinDist		; Reset minimum distance
    LOAD Mask0
    OR   Mask5
    OR   Mask1
...
LoopSideContinue2:
    ...
    CALL CheckMinDist5	; Checks minimum distance on other side
    ...
    IN DIST0
    ADDI -600
    JPOS MoveIn			; If distance > , jump to MoveIn!
    
    IN DIST0
    ADDI -475
    JPOS MoveInSmall			; If distance > 475, jump to MoveIn
        
    IN DIST0
    ADDI -80
    JNEG DontCurve		; If distance < 425, jump to MoveOut
...
; Values used for Scanning & related items
MinDist: DW &HFFFF
MinAngle: DW 0
StartingAngle: DW 0
TurnAmt: DW 10
